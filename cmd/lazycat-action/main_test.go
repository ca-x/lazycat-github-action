...
func TestRunVersion(t *testing.T) {
	...
	if !strings.Contains(stdout.String(), `"toolkitVersion":"v0.3.2"`) || !strings.Contains(stdout.String(), `"referenceCliVersion":"2.0.8"`) || !strings.Contains(stdout.String(), `"targetPlatform":"linux/amd64"`) {
